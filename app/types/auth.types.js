...
export const REGISTER_ACCOUNT_SUCCESS = "registerAccountSuccess";
export const REGISTER_ACCOUNT_ERROR = "registerAccountError";
export const REGISTER_ACCOUNT_LOADING = "registerAccountLoading";
