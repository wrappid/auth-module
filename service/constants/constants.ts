const constant = {
  ...
  communication: {
    ...
    SENT_OTP_LOGIN_WITH_OTP_SMS_EN: "sent_otp_login_with_otp_sms_en",
    SENT_OTP_RESET_PASSWORD_OTP_SMS_EN: "sent_otp_reset_password_otp_sms_en",
    SENT_OTP_LOGIN_WITH_OTP_MAIL_EN: "sent_otp_login_with_otp_mail_en",
    SENT_OTP_RESET_PASSWORD_MAIL_EN: "sent_otp_reset_password_mail_en",
